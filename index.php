...
<body data-spy="scroll" data-target=".navbar-collapse">
  ...
  <div id="display-banner">
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-md-offset-3">
        ...
        <p align="center" id="result"><strong>
            <?php echo $result; ?> </strong></p><br /><br /><br /><br />
  ...
  <!--end insurance-company-features-->
  ...
  <div align="center" class="social-links">
    ...
    <a href="https://www.linkedin.com/BROKERS-LINKED-IN-ACCOUNT/"><svg height="35" viewbox="0 0 24 24" width="35">
        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" fill="#615F61"></path>
      </svg></a>

    <!--FACEBOOK SOCIAL ICON-->
    <a href="https://www.facebook.com/BROKERS-FACEBOOK-ACCOUNT/" target="_blank"><svg style="width:35px; height:35px" viewbox="0 0 24 24">
        <path d="M17,2V2H17V6H15C14.31,6 14,6.81 14,7.5V10H14L17,10V14H14V22H10V14H7V10H10V6A4,4 0 0,1 14,2H17Z" fill="#615F61"></path>
      </svg></a>
